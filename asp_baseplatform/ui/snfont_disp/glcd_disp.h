...
#define Font8   Embedded_Font9
#define Font12  Shinonome_Font12
#define Font16  Shinonome_Font16
...
extern const font_t *lcd_getFontTable(font_head_t *phead, uint8_t *ptr);
