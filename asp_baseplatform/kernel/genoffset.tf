...
$  SIL_ENDIANの誤定義の検出
$ 
$IF SIL_ENDIAN_BIG && SIL_ENDIAN_LITTLE$
	$ERROR$Both SIL_ENDIAN_BIG and SIL_ENDIAN_LITTLE are defined.$END$
	$DIE()$
$END$
$IF !SIL_ENDIAN_BIG && !SIL_ENDIAN_LITTLE$
	$ERROR$Neither SIL_ENDIAN_BIG nor SIL_ENDIAN_LITTLE is defined.$END$
	$DIE()$
$END$
