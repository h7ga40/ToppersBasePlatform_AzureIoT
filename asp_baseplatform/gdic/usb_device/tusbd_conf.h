...
#define tusbdDriverSetUSBAddress(d, a)  usbd_setDevAddress(((d)->pSysData), (a))
#define tusbdDriverGetRxDataSize        usb_device_getrxdatasize

#define tusbdDriverInit                 usb_device_init
#define tusbdDriverDeInit               usb_device_deinit
#define tusbdDriverStart                usb_device_start
#define tusbdDriverStop                 usb_device_stop
#define tusbdDriverOpenEp               usb_device_openep
#define tusbdDriverCloseEp              usb_device_closeep
#define tusbdDriverFlushEp              usb_device_flushep
#define tusbdDriverStallEp              usb_device_stallep
#define tusbdDriverClearStallEp         usb_device_clearep
#define tusbdDriverStallConditionEp     usb_device_getstallcondition
#define tusbdDriverStartTransmit        usb_device_transmitdata
#define tusbdDriverSetupReceive         usb_device_startreceive
#define tusbdDriverTestMode             usb_device_testmode
