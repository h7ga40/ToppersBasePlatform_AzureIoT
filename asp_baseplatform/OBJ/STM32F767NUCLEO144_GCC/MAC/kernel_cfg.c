...
const ID _kernel_torder_table[TNUM_STSKID] = {
	LOGTASK, MONTASK, LWIP_TASK_1, LWIP_TASK_2, LWIP_TASK_3, LWIP_TASK_4, LWIP_TASK_5, LWIP_TASK_6, LWIP_TASK_7, LWIP_TASK_8, LWIP_TASK_N, MAIN_TASK1
};
...
const ISR_ENTRY _kernel_isr_queue_list[3] = {
	{ 55, &(_kernel_isr_queue_table[0]) },
	{ 77, &(_kernel_isr_queue_table[1]) },
	{ 87, &(_kernel_isr_queue_table[2]) }
};
...
const ISRINIB _kernel_sisrinib_table[TNUM_SISR] = {
	{ (TA_NULL), (intptr_t)(1), (INTNO_SIO1), (&(_kernel_isr_queue_table[0])), (sio_usart_isr), (1) },
	{ (TA_NULL), (intptr_t)(2), (INTNO_SIO2), (&(_kernel_isr_queue_table[2])), (sio_usart_isr), (1) },
	{ (TA_NULL), (intptr_t)(EMAC_PORTID), (INTNO_EMAC), (&(_kernel_isr_queue_table[1])), (emac_hps_isr), (1) }
};
...
_kernel_call_inirtn(void)
{
	...
	((INIRTN)(heap_init))((intptr_t)(heap_param));
